...
.controller('MenuController', ['$scope', '$state', '$stateParams', 'menuFactory', 'favoriteFactory',
    function ($scope, $state, $stateParams, menuFactory, favoriteFactory) {
        ...
        $scope.addToFavorites = function (dishid) {
            ...
            favoriteFactory.save(dishid, { id: dishid });
            $scope.showFavorites = !$scope.showFavorites;
        };
    }])
